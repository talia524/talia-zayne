...
(function (global) {
    ...
    function buildModuleSkipPatterns(flags) {
        ...
        if (!flags.inclMoments) p.push('moments_data', 'moments_publish_draft', 'moments_profile', 'moments_partner_name', 'moments_partner_avatar', 'moments_visitor_records', 'moments_friends', 'moments_reply_speed', 'moments_active_comment_min', 'moments_active_comment_max', 'moments_active_comment_min_value', 'moments_active_comment_max_value', 'moments_active_comment_min_unit', 'moments_active_comment_max_unit', 'moments_reply_comment_min', 'moments_reply_comment_max', 'moments_reply_comment_min_value', 'moments_reply_comment_max_value', 'moments_reply_comment_min_unit', 'moments_reply_comment_max_unit', 'moments_reply_count_min', 'moments_reply_count_max', 'moments_friend_like', 'moments_cover');
